...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        //frontCamera = CameraServer.startAutomaticCapture(Constants.CameraSystem.getFrontCamera());//use for camera on smart Dashboard
        rearCamera = CameraServer.startAutomaticCapture(Constants.CameraSystem.getRearCamera());

        //server = CameraServer.addSwitchedCamera("switched camera");
