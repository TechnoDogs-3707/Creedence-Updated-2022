...
public class CargoIntakeSubsystem extends Subsystem {
    ...
    private DoubleSolenoid tonguePneumatic = new DoubleSolenoid(Constants.PneumaticSystem.getPcmCanId(), PneumaticsModuleType.CTREPCM, Constants.CargoIntakeSystem.getTongueSolenoidForward(), Constants.CargoIntakeSystem.getTongueSolenoidReverse());
