...
public class HatchSubsystem extends Subsystem {
    ...
    private DoubleSolenoid clawClamp = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, Constants.HatchSystem.getClampSolenoidForward(), Constants.HatchSystem.getClampSolenoidReverse());
    private DoubleSolenoid thrust = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, Constants.HatchSystem.getThrustSolenoidForward(), Constants.HatchSystem.getThrustSolenoidReverse());
